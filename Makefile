# Produce CRDs that support latest kubernetes version (no version conversion)
...
# Generate code
generate: $(GOBIN)/controller-gen chaos-build ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
