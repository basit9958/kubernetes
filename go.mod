...
require (
	...
	k8s.io/kubernetes/api v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/Microsoft/hcsshim/test v0.0.0-20220728073108-fcf074dcb6f5 // indirect
