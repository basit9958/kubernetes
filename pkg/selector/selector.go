...
import (
	...
	"k8s.io/kubernetes/pkg/selector/aws"
	"k8s.io/kubernetes/pkg/selector/azure"
	"k8s.io/kubernetes/pkg/selector/container"
	"k8s.io/kubernetes/pkg/selector/gcp"
	"k8s.io/kubernetes/pkg/selector/nodevolumepath"
	"k8s.io/kubernetes/pkg/selector/physicalmachine"
	"k8s.io/kubernetes/pkg/selector/pod"
)
