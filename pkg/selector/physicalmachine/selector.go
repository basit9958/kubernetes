...
import (
	...
	"k8s.io/kubernetes/controllers/config"
	stdLog "k8s.io/kubernetes/pkg/log"
	"k8s.io/kubernetes/pkg/selector/generic"
	genericannotation "k8s.io/kubernetes/pkg/selector/generic/annotation"
	genericfield "k8s.io/kubernetes/pkg/selector/generic/field"
	genericlabel "k8s.io/kubernetes/pkg/selector/generic/label"
	genericnamespace "k8s.io/kubernetes/pkg/selector/generic/namespace"
	"k8s.io/kubernetes/pkg/selector/generic/registry"
)
